										...
										echo "<tr id='linha".$i."'>";
											...
											for ($j = 0; $j < COUNT($lista_colunas_nota) ; $j++)
											{
												if($lista_colunas_nota[$j]['Descricao_nota_id'] != RECUPERACAO_PARALELA)
												{
													...
													echo"<td class='text-center' style='width: 10%;'>";
														echo"<input min='0' $status_etapa min='0' onblur='Main.altera_nota(\"total".$i."\", this.value,".$lista_colunas_nota[$j]['Descricao_nota_id'].",\"".$lista_alunos[$i]['Matricula_id']."\",".$url_part['etapa_id'].",\"aluno".$i."_nota".$j."\");' name='aluno".$i."_nota".$j."' type='number' value='".$nota."' class='form-control border_radius text-info' style='background-color: white;' />";
													echo"</td>";
												}
											}
											...
											for ($j = 0; $j < COUNT($lista_colunas_nota) ; $j++)
											{
												if($lista_colunas_nota[$j]['Descricao_nota_id'] == RECUPERACAO_PARALELA)
												{
													...
													echo"<td class='text-center' style='width: 10%;'>";
														echo"<input min='0' $status_etapa min='0' onblur='Main.altera_nota(\"total".$i."\", this.value,".$lista_colunas_nota[$j]['Descricao_nota_id'].",\"".$lista_alunos[$i]['Matricula_id']."\",".$url_part['etapa_id'].",\"aluno".$i."_nota".$j."\");' id='aluno".$i."_nota".$j."'  name='aluno".$i."_nota".$j."' type='number' value='".$nota."' class='form-control border_radius text-".$status."' style='background-color: white;' />";
													echo"</td>";
												}
											}
										echo "</tr>";
