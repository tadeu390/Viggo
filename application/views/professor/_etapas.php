<?php 
	...
	for ($i = 0; $i < COUNT($lista_etapas); $i++) 
	{
		...
		echo "<div class='col-lg-4  my-2'>";
			echo "<a href='".$url."professor/".(($lista_etapas[$i]['Tipo'] == ETAPA_EXTRA) ? 'etapa_extra' : $method)."/".$url_part['disciplina_id']."/".$url_part['turma_id']."/".$lista_etapas[$i]['Id']."' class='btn ".$partial_class." btn-block'>";
