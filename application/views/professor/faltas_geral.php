			...
			<div class="col-lg-10">
				...
				<div class="row padding10">
					...
					<div class="col-lg-4 text-right">
						<a href="<?php echo $url; ?>professor/faltas_geral/<?php echo $url_part['disc_grade_id']."/".$url_part['turma_id']."/".$url_part['bimestre_id']; ?>" class="btn btn-success" style="width: 100px">Geral</a>
						<a href="<?php echo $url; ?>professor/faltas/<?php echo $url_part['disc_grade_id']."/".$url_part['turma_id']."/".$url_part['bimestre_id']; ?>" class="btn btn-danger" style="width: 100px; margin-left: -8px; border-radius: 0px 5px 5px 0px;">Detalhado</a>
					</div>
				</div>
			</div>
		</div>
