	...
	*/
	class Modalidade_model extends CI_Model 
	{
		...
		*/
		...
		/*!
		*	RESPONSÁVEL POR RETORNAR UM PERÍODO LETIVO CADASTRADO EM UMA DETERMINADA MODALIDADE DO BANCO DE DADOS.
		*	
		...
		*/
		public function get_periodo_por_modalidade($modalidade_id)
		{
			$query = $this->db->query("
				...
				WHERE pl.Modalidade_id = ".$this->db->escape($modalidade_id)." AND Ativo = 1 ORDER BY Id DESC LIMIT 1");
